...
describe Integer do
  context "should convert" do
    ...
    it "number to kanji 100000000000000000000000000000000000000000000000000" do
      expect(['佰極','百極'].include?('100000000000000000000000000000000000000000000000000'.to_kansuji())).to be true
    end
  end
end
